            ...
            NoteButton(text = "Save",
                onClick = {
                    if (title.isNotEmpty() && description.isNotEmpty()) {
                        onAddNote(com.example.note_app.model.Note(title = title,
...
fun NoteRow(modifier: Modifier = Modifier,
            note: com.example.note_app.model.Note,
            onNoteClicked: (com.example.note_app.model.Note) -> Unit) {
...
fun NotesScreenPreview() {
    NoteScreen(
        notes = NotesDataSource().loadNotes() as MutableList<Note>,
        onAddNote = {},
        onRemoveNote = { })
}